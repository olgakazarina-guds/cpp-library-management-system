      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center space-x-2">
            <h2 className="text-xl font-bold text-slate-900 tracking-tight uppercase">Virtual C++ Runtime Engine</h2>
          ...
          <p className="text-xs text-slate-500 font-medium mt-1 max-w-2xl">
            Test the MyLibrary C++ backend operations live. Observe encapsulation accessors, Member inheritance borrowing limits (Regular = 3, Premium = 5), and BookRepository composition updates on Russian Literature classics.
          </p>
        </div>
        ...
        <div className="flex flex-wrap items-center gap-2 w-full md:w-auto">
          ...
          <button
            ...
            className="flex items-center space-x-1.5 px-3.5 py-2 rounded-lg text-xs font-bold uppercase tracking-wider bg-slate-900 hover:bg-slate-800 text-white shadow-sm transition"
          >
            <Plus className="w-3.5 h-3.5" />
          ...
          <button
            onClick={handleReset}
            className="flex items-center space-x-1.5 px-3.5 py-2 rounded-lg text-xs font-bold uppercase tracking-wider bg-white hover:bg-gray-50 text-slate-700 border border-gray-300 shadow-sm transition"
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm flex flex-col h-[620px]">
          <div className="flex items-center justify-between pb-3 border-b border-gray-100 mb-3">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-900 uppercase">BookRepository</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-5 shadow-sm flex flex-col h-[620px]">
          <div className="flex items-center justify-between pb-3 border-b border-gray-100 mb-3">
            <div className="flex items-center space-x-2">
              ...
              <div>
                <h3 className="text-sm font-bold text-slate-900 uppercase">Virtual C++ std::cout Stream</h3>
                <p className="text-[11px] text-slate-500 font-medium">Method Traces & State Output</p>
              </div>
            </div>
            ...
            <form onSubmit={handleRegisterMember} className="space-y-3 text-xs font-medium">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2 mt-1">
                  ...
                  >
                    <span className="font-bold block">RegularMember</span>
                  ...
                  >
                    <span className="font-bold block">PremiumMember</span>
